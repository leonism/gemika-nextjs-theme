  ...
  return (
    <div className="flex flex-wrap items-center justify-center gap-3 sm:gap-4 md:gap-6 lg:gap-8 xl:gap-10">
      {brands.map((brand, index) => (
        ...
        >
          <div className="absolute inset-0 rounded-full bg-linear-to-br from-indigo-100 to-purple-100 opacity-0 transition-opacity duration-300 group-hover:opacity-100">
		  </div>
          <Image
