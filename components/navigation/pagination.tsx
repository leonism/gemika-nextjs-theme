          ...
          <li key={index}>
            {typeof page === 'number' ? (
              <Link
                ...
                } rounded-full border border-gray-300 shadow-sm transition-all duration-300 hover:border-transparent hover:bg-linear-to-r hover:from-indigo-600 hover:to-emerald-600 hover:text-white dark:border-gray-700`}
              >
                {page}
              </Link>
            ) : (
