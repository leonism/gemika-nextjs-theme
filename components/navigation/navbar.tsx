...
export function Navbar({
  ...
  return (
    <header className="sticky top-0 z-50 w-full h-14 sm:h-16 md:h-18 lg:h-20 border-b border-gray-200/50 shadow-md bg-white/70 dark:bg-gray-900/70 dark:border-gray-800/50">
      ...
      {cta?.href && cta?.label && (
        <Link href={cta.href} className="block">
          <Button
            variant="default"
            size="sm"
            className="px-3 py-1 sm:px-4 sm:py-1.5 md:px-5 md:py-2 rounded-full bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white font-medium transition-all duration-300 text-xs sm:text-sm md:text-base shadow-sm hover:shadow-md"
          >
            {cta.label}
          </Button>
        </Link>
