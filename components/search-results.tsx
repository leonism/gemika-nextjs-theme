    ...
    return (
      <div className="space-y-4 sm:space-y-6">
        {[...Array(3)].map((_, i) => (
          <div
            key={i}
            className="p-4 sm:p-5 rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900/50 animate-pulse"
            aria-hidden="true"
          >
    ...
    return (
      <div className="text-center py-8 sm:py-12 space-y-4">
        <div className="space-y-2">
          ...
          <p className="text-gray-600 dark:text-gray-400 px-4 sm:px-0">
