...
export function ResponsiveImage({
  ...
  return (
    <div className={cn("relative overflow-hidden rounded-lg", aspectRatioClass, className)} style={customStyle}>
      <Image src={imageSrc || "/placeholder.svg"} alt={alt} fill sizes={sizes} className="object-cover" {...props} />
    </div>
  )
}
