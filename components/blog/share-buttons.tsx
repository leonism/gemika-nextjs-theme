...
export function ShareButtons({ title, slug }: ShareButtonsProps) {
  ...
  const socialShares = [
    ...
    },
    {
      ...
      icon: (
        <svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor">
          <path d="M12 2.04c-5.5 0-10 4.49-10 10.02 0 5.52 4.5 10.02 10 10.02S22 17.58 22 12.06c0-5.53-4.5-10.02-10-10.02zm0 18.02c-4.42 0-8-3.58-8-8.02 0-4.43 3.58-8.02 8-8.02s8 3.59 8 8.02c0 4.44-3.58 8.02-8 8.02z" /><path d="M13.5 12.06h-1.5v6h-3v-6h-1.5v-3h1.5v-2.25c0-1.5 1-2.75 2.75-2.75h2.25v3h-1.5c-.25 0-.5.25-.5.5V9.06h2.25l-.75 3z" />
        </svg>
      ),
    },
    {
    ...
    },
    {
        ...
        icon: (
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm-1-12h2v2h-2zm0 4h2v6h-2z"/></svg>
        ),
    },
    {
        name: 'Telegram',
        ...
        icon: (
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm-2-9l-3 8 1.5 1 2.5-6 2.5 6 1.5-1-3-8v-4h-2v4z"/></svg>
        ),
    },
    {
        name: 'Email',
  ...
  return (
    <div className="my-8 flex flex-col items-center justify-center space-y-4 rounded-lg border bg-slate-50 p-4 dark:border-slate-700 dark:bg-slate-800 sm:flex-row sm:space-y-0 sm:space-x-4">
