...
import { Facebook, Link2, Linkedin, MessageCircleWarning, Twitter } from 'lucide-react'
...
export function ShareButtons({ title, url, className }: ShareButtonsProps) {
  ...
  return (
    <div className={className}>
      <h4 className="mb-3 text-sm font-medium text-gray-900 dark:text-gray-100">Share this post</h4>
