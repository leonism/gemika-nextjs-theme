    ...
    <html lang="en" suppressHydrationWarning className={`${inter.variable} scroll-smooth`}>
      <body className="bg-gray-50 text-gray-900 dark:bg-[#111927] dark:text-gray-100 antialiased transition-colors duration-500">
        <ThemeProvider attribute="class" defaultTheme="system" enableSystem>
          ...
          <header className="sticky top-0 z-50 backdrop-blur-lg bg-white/80 dark:bg-[#1A2332]/90 border-b border-gray-200/50 dark:border-[#313F55]/50 shadow-sm shadow-gray-200/10 dark:shadow-[#141D2B]/20">
