...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: siteUrl,
    types: {
      'application/rss+xml': [{ url: '/feed.rss', title: 'RSS Feed' }],
      'text/markdown': [{ url: `${siteUrl}/index.md`, title: 'Markdown version' }],
    },
  },
}
    ...
    <html lang="en" suppressHydrationWarning>
      ...
      >
        ...
        <div className="pointer-events-none fixed inset-0 z-[-1] overflow-hidden">
          <div className="animate-blob absolute -left-20 top-1/4 h-72 w-72 rounded-full bg-indigo-200 opacity-20 mix-blend-multiply blur-3xl filter dark:opacity-10">
		  </div>
          <div className="animate-blob animation-delay-2000 absolute -right-20 top-1/2 h-72 w-72 rounded-full bg-emerald-200 opacity-20 mix-blend-multiply blur-3xl filter dark:opacity-10">
		  </div>
          <div className="animate-blob animation-delay-4000 absolute bottom-1/4 left-1/4 h-72 w-72 rounded-full bg-amber-200 opacity-20 mix-blend-multiply blur-3xl filter dark:opacity-10">
		  </div>
        </div>
        <BackToTop />
      </body>
